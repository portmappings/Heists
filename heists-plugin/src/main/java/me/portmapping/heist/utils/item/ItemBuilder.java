package me.portmapping.heist.utils.item;

import me.portmapping.heist.utils.chat.CC;
import me.portmapping.heist.utils.chat.Symbols;
...
public class ItemBuilder {
    ...
    public ItemBuilder setNameWithArrows(String name) {
        String color = "&f";
        ItemMeta im = is.getItemMeta();
        im.setDisplayName(CC.t(color + Symbols.ARROW_RIGHT + " " + name + " " + color + Symbols.ARROW_LEFT));
        is.setItemMeta(im);
        return this;
    }
