...
import me.portmapping.heist.scoreboard.USBOptions;
...
public class Board {
    ...
    private final USBScoreboard usbScoreboard;
    private final USBOptions options;

    public Board(Player player, USBScoreboard usbScoreboard, USBOptions options) {
        this.player = player;
        this.usbScoreboard = usbScoreboard;
    ...
    private void setup() {
        ...
        if (usbScoreboard.getAdapter() != null) {
            objective.setDisplayName(ChatColor.translateAlternateColorCodes('&', usbScoreboard.getAdapter().getTitle(player)));
        } else {
